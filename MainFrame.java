...
import static ProjectA.APIconnection.parse;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ghibli_back = new javax.swing.JButton();
        ...
        data_Panel.setBounds(0 , 0 , 995 , 610);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
         ...
         jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
               "ID" , "Title", "Description" , "Director" , "Producer" , "Release_Date" , "Rating"
            }
        ){
            boolean[] canEdit = new boolean [] {
        ...
        ghibli_back.setText("Back");
        ghibli_back.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ghibli_backActionPerformed(evt);
            }
        });
        data_Panel.add(ghibli_back);
        ghibli_back.setBounds(10, 10, 80, 40);
        ...
        htp_btn.setText("Studio Ghibli");
        getContentPane().add(htp_btn);
        htp_btn.setBounds(120, 310, 140, 40);
        
        htp_btn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                htp_btnActionPerformed(evt);
            }
        });

        hs_btn1.setText("High Score");
        getContentPane().add(hs_btn1);
        hs_btn1.setBounds(120, 250, 140, 40);
    ...
    public ArrayList<Score_sheet> score_sheet(){
     ...
     public ArrayList<Data_sheet> Data_sheet(){
        
        ArrayList<Data_sheet> data_sheetlist = new ArrayList<Data_sheet>();
        ...
        try{
            ...
            //URL url = new URL(" https://api.jikan.moe/v3/search/anime?q=love%20is%20war");
            ...
            for(int i = 0 ; i < albums.length() ; i++){
                ...
                String director = album.getString("director");
                String producer = album.getString("producer");
                int release_date = (int) (long) album.getInt("release_date");
                int rt_score =(int) (long) album.getInt("rt_score");

                data = new Data_sheet(id , title , description , director , producer , release_date , rt_score);
                data_sheetlist.add(data);
            ...
            return data_sheetlist;
    }
    
    public void showScore_Sheet(){
     ...
     public void showData_Sheet(){
        ...
        ArrayList<Data_sheet> list = Data_sheet();
        ...
        for (int i = 0 ; i < list.size() ; i++){
            ...
            row[3] = list.get(i).getDirector();
            row[4] = list.get(i).getProducer();
            row[5] = list.get(i).getRelease_Date();
            row[6] = list.get(i).getRT_Score();
            model.addRow(row);
        }
      ...
      private void score_editBtnActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(score_textField.getText().isBlank() && user_textField.getText().isBlank())
            JOptionPane.showMessageDialog(null, "No Data to be Edit");
             ...
             //JOptionPane.showMessageDialog(null, "Activation key Sent to your Email");
//             
              Random r = new Random();
              String randomNumber = String.format("%04d", Integer.valueOf(r.nextInt(1001)));
              
              javaMail(randomNumber);
//              
//              Test a = new Test(null , randomNumber);
...
//              
            ...
            int action = JOptionPane.showConfirmDialog(null, pwd,"Enter Authentication Key",JOptionPane.OK_CANCEL_OPTION);
            
            
            if(action == 0){
                jTable2.disable();
                
                if(new String(pwd.getText()).equals(randomNumber)){
    ...
    private void score_backActionPerformed(java.awt.event.ActionEvent evt) {                                         
     ...
     private void ghibli_backActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    ...
    private void score_delete_BtnActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(score_textField.getText().isBlank() && user_textField.getText().isBlank())
            ...
            int action = JOptionPane.showConfirmDialog(null, pwd,"Enter Key",JOptionPane.OK_CANCEL_OPTION);
    ...
    private void exit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exit_btnActionPerformed
     ...
     private void hs_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exit_btnActionPerformed
      ...
      private void htp_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exit_btnActionPerformed
    ...
    public void javaMail(String randomNumber){
           final String username = "devillahemwe@gmail.com";
           final String password = "leave12123";
           ...
           try {
               ...
               message.setFrom(new InternetAddress("devillahemwe@gmail.com"));
               message.setRecipients(Message.RecipientType.TO,
                   InternetAddress.parse("devillahemwe@gmail.com"));
               message.setSubject("Key Number");
               message.setText(" Your Key  Number is: <h1>" + randomNumber + "</h1>");
    ...
    private javax.swing.JButton ghibli_back;
